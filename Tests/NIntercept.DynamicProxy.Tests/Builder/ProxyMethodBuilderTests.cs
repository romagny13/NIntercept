...
namespace NIntercept.Tests.Builder
{
    ...
    public class ProxyMethodBuilderTests
    {
        ...
        public void Attributes_Added()
        {
            ...
            var moduleBuilder = TestHelpers.GetNewModule();
            var typeBuilder = TestHelpers.GetNewTypeBuilder(moduleBuilder);
            ...
            var methodBuilder = builder.CreateMethod(moduleBuilder, typeBuilder, typeMet, typeMet.Method, fields);
    ...
    public class TestHelpers
    {
        ...
        {
            ProxyModuleBuilder moduleScope = GetNewModuleScope();
            return moduleScope.Module;
        }

        public static ProxyModuleBuilder GetNewModuleScope()
        {
            return new ProxyModuleBuilder($"DynAssembly{Guid.NewGuid()}", $"DynModule{Guid.NewGuid()}");
        }
