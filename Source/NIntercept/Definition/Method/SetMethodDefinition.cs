...
{
    public sealed class SetMethodDefinition : MethodDefinition
    {
        private PropertyDefinition propertyDefinition;
        private Type[] parameterTypes;
        private string callerMethodFieldName;

        public SetMethodDefinition(TypeDefinition typeDefinition, PropertyDefinition propertyDefinition, MethodInfo method) : base(typeDefinition, method)
        {
