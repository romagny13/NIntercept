...
namespace NIntercept
{
    public class InvocationTypeBuilder : IInvocationTypeBuilder
    {
        public virtual Type CreateType(ModuleBuilder moduleBuilder, InvocationTypeDefinition invocationTypeDefinition, MethodBuilder concreteMethodBuilder)
        {
            ...
            GenericTypeParameterBuilder[] genericTypeParameters = TypeBuilderHelper.DefineGenericParameters(typeBuilder, invocationTypeDefinition.GenericArguments);
        ...
        protected virtual PropertyBuilder ImplementInterceptorProviderTypeProperty(TypeBuilder typeBuilder, ProxyMethodDefinition methodDefinition)
        {
        ...
        protected Type GetInterceptorProviderType(ProxyMethodDefinition methodDefinition)
        {
        ...
        protected virtual void DefineConstructors(TypeBuilder typeBuilder, InvocationTypeDefinition invocationTypeDefinition)
        {
            ...
            TypeBuilderHelper.AddConstructor(typeBuilder, new Type[] { targetType, typeof(IInterceptor[]), typeof(MemberInfo), typeof(MethodInfo), typeof(object), typeof(object[]) }, InvocationMethods.InvocationDefaultConstructor);
        }
